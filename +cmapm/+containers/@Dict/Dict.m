classdef Dict < cmapm.containers.Container
    ...
    methods
        ...
        function keys = sortKeysOnValue(obj, direc)
            ...
            if cmapm.util.DataType.isNumericType(obj.data_.ValueType)
        ...
        function v = get(obj, k, varargin)
            ...
            if nargin > 2
                ...
                if ismember(obj.data_.ValueType, {'single', 'double'})
                    d = cast(obj.default_, obj.data_.ValueType);
                else
                    d = obj.default_;
                end
        ...
        function dict = parse_(obj, varargin)
            ...
            if isequal(nin, 1)
                if isa(varargin{1}, 'containers.Map')
                    dict = varargin{1};
                elseif isa(varargin{1}, 'cmapm.containers.List')
