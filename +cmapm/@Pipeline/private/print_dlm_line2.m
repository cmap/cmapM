function varargout = print_dlm_line2(li,varargin)
% PRINT_DLM_LINE2 Print a delimited line.
% PRINT_DLM_LINE2(LI) prints the cell array LI to as a tab-delimited
% string to STDOUT.
% S = PRINT_DLM_LINE(LI) returns a char string of the delimited data.
% PRINT_DLM_LINE2(LI, 'Param1', 'Value1',...)
% Valid options
...
fmt = ['%s',arg.dlm];
numfmt = sprintf('%%.%dg', arg.precision);
