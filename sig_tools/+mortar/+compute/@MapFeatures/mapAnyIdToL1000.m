function [out_gmt, unmapped_gmt] = mapAnyIdToL1000(in_gset, input_id, l1k_space)
...
switch lower(input_id)
    case 'gene_symbol'
        [out_gmt, unmapped_gmt] = mortar.compute.MapFeatures.mapGeneSymbolToL1000(in_gset, l1k_space);
    case 'gene_id'
        [out_gmt, unmapped_gmt] = mortar.compute.MapFeatures.mapGeneIdToL1000(in_gset, l1k_space);
    case 'affx'
        [out_gmt, unmapped_gmt] = mortar.compute.MapFeatures.mapAffxToL1000(in_gset, l1k_space);
    otherwise       
