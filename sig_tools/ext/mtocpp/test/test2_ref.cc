...
static mlhsInnerSubst<void> grid::rect::rectgrid::test(::othergrid auto_param,matlabtypesubstitute b,::test c) {
...
/** @fn mlhsInnerSubst<void> grid::rect::rectgrid::test(::othergrid auto_param,matlabtypesubstitute b,::test c)
