...
/** @file "test/+grid/+rect/doxygen_in_namespace.m"
  ...
  */
/** @fn mlhsInnerSubst<void> doxygen(matlabtypesubstitute param1,matlabtypesubstitute param2,::othergrid auto_param)
  * @brief  Here comes a short description text
  *
  *
...
/** @fn mlhsSubst<mlhsInnerSubst<void,d> ,mlhsInnerSubst<void,e> ,mlhsInnerSubst<void,f> > mtoc_subst_doxygen_in_namespace_m_tsbus_cotm_third_function_with_sev_retvals(::othergrid auto_param)
