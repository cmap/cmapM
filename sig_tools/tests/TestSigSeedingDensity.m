classdef TestSigSeedingDensity < matlab.unittest.TestCase
	% TestSigSeedingDensity Unit and functional tests for SigSeedingDensity
    ...
    properties
        sig_class = @mortar.sigtools.SigSeedingDensity
        sig_tool = 'sig_seedingdensity_tool';
