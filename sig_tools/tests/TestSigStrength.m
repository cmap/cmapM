classdef TestSigStrength < matlab.unittest.TestCase
	% TestSigStrength Unit and functional tests for SigStrength
    ...
    properties
        sig_class = @mortar.sigtools.SigStrength
        sig_tool = 'sig_strength_tool';
